class RAGPipeline:
    ...
    def __init__(self, llm_manager, db_connector):
        ...
        self.entity_extractor = EntityExtractor(self.db, self.llm)
        self.query_generator = SQLQueryGenerator(self.llm, self.db)
    ...
    def _generate_response(self, user_query, sql_query, query_results):
        ...
        prompt = f"""
        Based on the following information, provide a natural language answer to the user's question.
